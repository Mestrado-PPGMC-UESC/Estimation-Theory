...
class EstimadorGaussNewton:

    def __init__(self, numero_passos, I0, S0, R0, dados_observados, max_iter=500, tolerancia=1e-8, epsilon=1e-6):
        ...
        # Número máximo de iterações do Gauss-Newton
        self.max_iter = max_iter

        # Critério de convergência
        self.tolerancia = tolerancia

        # Perturbação usada na derivada numérica
